...
//{
    ...
    /// </summary>
    public abstract class ConfigRayComponentBase : SensorComponent
    {
        [HideInInspector, SerializeField, FormerlySerializedAs("sensorName")]
        string m_SensorName = "ConfigRaySensor";
    ...
    public SensorInfoType infoType;
        ...
        internal Color rayHitColor = Color.green;
    ...
    [HideInInspector]
    [SerializeField]
    internal Color rayHitNonSensorColor = Color.red;


    [NonSerialized]
        ConfigRaySensor m_RaySensor;

        /// <summary>
        /// Get the ConfigRaySensor that was created.
        /// </summary>
        public ConfigRaySensor RaySensor
        {
            get => m_RaySensor;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public abstract ConfigRayCastType GetCastType();
        ...
        public override ISensor CreateSensor()
        {
            ...
            m_RaySensor = new ConfigRaySensor(m_SensorName, rayPerceptionInput);
        ...
        public override int[] GetObservationShape()
        {
            ...
            var obsSize = (int)infoType * numRays;
            var stacks = ObservationStacks > 1 ? ObservationStacks : 1;
            return new[] { obsSize * stacks };
        }

        /// <summary>
        /// Get the RayPerceptionInput that is used by the <see cref="ConfigRaySensor"/>.
        /// </summary>
        /// <returns></returns>
        public ConfigRayInput GetRayPerceptionInput()
        {
            var rayAngles = GetRayAngles(RaysPerDirection, MaxRayDegrees);

            var rayPerceptionInput = new ConfigRayInput();
            rayPerceptionInput.RayLength = RayLength;
            rayPerceptionInput.infoType = infoType;
        ...
        public void UpdateSensor()
        {
            if (m_RaySensor != null)
            {
                ...
                m_RaySensor.SetConfigRayInput(rayInput);
            }
        }
            ...
            else
            {
               ...
               // rayInput.DetectableTags = null;
                for (var rayIndex = 0; rayIndex < rayInput.Angles.Count; rayIndex++)
                {
                    ...
                    ConfigRaySensor.PerceiveSingleRay(rayInput, rayIndex, out debugRay);
    ...
    void DrawRaycastGizmos(DebugDisplayInfo.RayInfo rayInfo, float alpha = 1.0f)
        ...
        var startPositionWorld = rayInfo.worldStart;
            ...
            var color = Color.Lerp(rayHitNonSensorColor, rayMissColor, lerpT);
            color.a *= alpha;
            if (rayInfo.si != null)
            color = rayHitColor;
            Gizmos.color = color;
